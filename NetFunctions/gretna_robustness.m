function [LarComSize Lp] = gretna_robustness(A ,n)

%==========================================================================
% This function is used to assess the resilience of a binary network G to
...
%
%
% Syntax: function [LarComSize Lp] = gretna_robustness(A)
%
% Input:
%     A:
...
fprintf('Calculating largest component size and shortest path length when target attack \n');
...
% initial Lp of Net1
[averlp, ~] = gretna_node_shortestpathlength(Net1);
...
fprintf('Calculating largest component size and shortest path length when random error \n');
...
for i = 1:n
    ...
    % initial Lp of Net2
    [averlp, ~] = gretna_node_shortestpathlength(Net2);
