function Process=gretna_GEN_Hierarchy(InputFile, RandNetFile, OutputFile, NType)
%-------------------------------------------------------------------------%
...
Process.command='gretna_RUN_Hierarchy(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType)';
% Option 
