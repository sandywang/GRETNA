function Process=gretna_GEN_BetweennessCentrality(InputFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Nodal - Betweenness Centrality
%   Input:
...
Process.command='gretna_RUN_BetweennessCentrality(opt.InputFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
