function Process=gretna_GEN_T1Dcm2Nii(InputFile, OutputFile)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for T1's DICOM to NIfTI
%   Input:
...
Process.command='gretna_RUN_T1Dcm2Nii(opt.InputFile, opt.OutputFile)';
% Option 
