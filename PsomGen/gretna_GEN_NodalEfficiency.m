function Process=gretna_GEN_NodalEfficiency(InputFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Nodal - Efficiency
%   Input:
...
Process.command='gretna_RUN_NodalEfficiency(opt.InputFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
