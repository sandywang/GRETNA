function Process=gretna_GEN_NodalShortestPath(InputFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Nodal - Shortest Path Length
%   Input:
...
Process.command='gretna_RUN_NodalShortestPath(opt.InputFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
