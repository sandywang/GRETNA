function Process=gretna_GEN_GEfficiency(InputFile, RandNetFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Global - Efficiency
%   Input:
...
Process.command='gretna_RUN_GEfficiency(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
