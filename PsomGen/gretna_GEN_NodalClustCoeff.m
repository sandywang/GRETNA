function Process=gretna_GEN_NodalClustCoeff(InputFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Nodal - Clusting Coefficient
%   Input:
...
Process.command='gretna_RUN_NodalClustCoeff(opt.InputFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
