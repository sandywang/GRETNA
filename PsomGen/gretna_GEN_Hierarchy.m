function Process=gretna_GEN_Hierarchy(InputFile, RandNetFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Global - Hierarchy
%   Input:
...
Process.command='gretna_RUN_Hierarchy(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
