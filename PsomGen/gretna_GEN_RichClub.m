function Process=gretna_GEN_RichClub(InputFile, RandNetFile, OutputFile, NType)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Global - Rich Club
%   Input:
...
Process.command='gretna_RUN_RichClub(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType)';
% Option 
