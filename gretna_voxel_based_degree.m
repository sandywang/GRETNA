function gretna_voxel_based_degree(Data_path, File_filter, Output_path, Data_mask, R_thr, Dis)

%==========================================================================
% This function is used to calculate nodal degree for each voxel in the
% brain.
%
% Syntax: function gretna_voxel_based_degree(Data_path, Output_path, File_filter, Data_mask)
%
% Inputs:
%       Data_path:
...
for i = 1:Num_subs
    ...
    fprintf('Calculating voxelwise degree for %s\n', [Dir_data{1}{i}]);
