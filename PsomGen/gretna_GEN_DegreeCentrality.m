function Process=gretna_GEN_DegreeCentrality(InputFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
...
Process.command='gretna_RUN_DegreeCentrality(opt.InputFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
