function Process=gretna_GEN_Synchronization(InputFile, RandNetFile, OutputFile, NType)
%-------------------------------------------------------------------------%
...
Process.command='gretna_RUN_Synchronization(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType)';
% Option 
