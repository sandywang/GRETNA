function Process=gretna_GEN_Synchronization(InputFile, RandNetFile, OutputFile, NType, AUCInterval)
%-------------------------------------------------------------------------%
%   Generate psom-used struct for Global - Synchronization
%   Input:
...
Process.command='gretna_RUN_Synchronization(opt.InputFile, opt.RandNetFile, opt.OutputFile, opt.NType, opt.AUCInterval)';
% Option 
